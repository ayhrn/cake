...
<div id="page-container" class="row">
	...
	<div id="sidebar" class="col-sm-2">
		...
		<div class="actions">
			...
			<ul class="list-group">
				<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Application.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Application.id'))); ?></li>
		...
		<div class="applications form">
			...
			<?php echo $this->Form->create('Application', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<div class="form-group">
						<?php echo $this->Form->input('date_submitted', array('class' => 'form-control')); ?>
					</div><!-- .form-group -->
					<div class="form-group">
					...
					<div class="form-group">
							<?php echo $this->Form->input('OSystem', array('multiple' => 'checkbox'));?>
					</div><!-- .form-group -->
